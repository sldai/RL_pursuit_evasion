...
class ConfigDWA():
    ...
    def __init__(self, max_v, min_v, max_w, max_acc_v, max_acc_w, v_reso=0.01, yawrate_reso=0.1, dt=0.1,
                 predict_time=1.0, to_goal_cost_gain=0.6, speed_cost_gain=0.3, ob_gain=0.3, robot_raduis=0.3, obstacle_radius=0.3):
        # robot parameter
...
if __name__ == '__main__':
    ...
    for i in range(1000):
        ...
        target_model.motion([1.8, -math.pi/5.0], config.dt)
        goal = target_model.state[:2]
